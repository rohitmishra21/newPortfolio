    ...
    return (
        <div className=''>
            <h1 className='text-2xl text-center name font-medium'>Let's work together, and create something <br />
                really amazing.</h1>
            <div className='flex justify-center mt-3.5'> <a href='https://www.linkedin.com/in/rohit-mishra-657759298/' className='px-7 py-2  text-xs shadow-lg shadow-green-700 text-white bg-green-600 rounded-4xl'>contact me i am available too work</a></div>
